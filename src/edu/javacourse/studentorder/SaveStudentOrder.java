...
import edu.javacourse.studentorder.dao.StudentOrderImpl;
...
//        }
        ...
        StudentOrderDao dao = new StudentOrderImpl();
    ...
    public static StudentOrder buildStudentOrder(long id) {
        ...
        // Муж
        Adult husband = new Adult("Петров","Виктор","Сергеевич",LocalDate.of(1998, 3, 12));
        ...
        // Ребенок2
        Child child2 = new Child("Петров", "Еагений", "Викторович", LocalDate.of(2020, 8, 29));
        child2.setCertificateNumber("" + (400000 + id));
        child2.setIssueDate(LocalDate.of(2020, 9 , 19));
